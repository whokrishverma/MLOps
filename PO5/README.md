...
6. **Now testing. What is an assert?**
7. **Write a module worth testing**
8. **Write the tests**
9. **Run the tests with one command**
10. **Break something on purpose**
11. **Test the model's behaviour, not its exact score**
12. **Share setup with conftest.py**
